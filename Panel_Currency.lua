...
local function MakeCheck(parent, key, label, x, y)
    local cb = CreateFrame("CheckButton", "BagsEnhCur" .. key, parent, "InterfaceOptionsCheckButtonTemplate")
    ...
    local function RefreshList()
        ...
        for i, cur in ipairs(list) do
            ...
            if not row then
                ...
                row.shared = CreateFrame("CheckButton", "BagsEnhCurShared" .. i, row, "InterfaceOptionsCheckButtonTemplate")
